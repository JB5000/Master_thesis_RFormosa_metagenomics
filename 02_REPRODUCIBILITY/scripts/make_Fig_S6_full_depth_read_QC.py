...
SOURCE = ROOT / "02_REPRODUCIBILITY" / "figure_sources" / "sequencing" / "S1_read_totals_source_fig2_sequencing_effort_qc_metrics.tsv"
OUT = Path(os.environ.get("RIA_FIGURE_OUTPUT", ROOT / "02_REPRODUCIBILITY" / "regenerated_output"))
