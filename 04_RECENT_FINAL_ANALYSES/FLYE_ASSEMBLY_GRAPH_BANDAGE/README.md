...
`01_FIGURES/final/Fig_S5_Flye_Bandage_top100_components.png` is an exploratory global rendering of the complete Flye assembly graph from the four-sample coassembly. It is not a filtered MAG graph and should not be interpreted as a genome map.
